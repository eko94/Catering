...
namespace Catering.Tests.Application.Contratos
{
    public class EntregaCanceladaHandlerTest
    {        
        ...
        public EntregaCanceladaHandlerTest()
        {
        ...
        [Fact]
        public async Task EntregaCanceladaHandler()
        {
            // Arrange
            ...
            CrearEntregaCanceladaHandler crearEntregaCanceladaHandler = new CrearEntregaCanceladaHandler(_contratoRepository.Object, _clienteRepository.Object, _unitOfWork.Object);
            ...
            await crearEntregaCanceladaHandler.Handle(new CrearEntregaCanceladaCommand(idContrato, fechaCancelada), tcs.Token);
            ...
            _contratoRepository.Verify(x => x.AddEntregaCancelada(It.IsAny<ContratoEntregaCancelada>()), Times.Once);
